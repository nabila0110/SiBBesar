...
@section('title', 'Tambah Jurnal - SiBBesar')

@section('content')
<div class="container-fluid mt-4">
    
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-book"></i> Tambah Jurnal</h2>
    ...
    <form method="POST" action="{{ route('jurnal.store') }}" id="journalForm">
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('item') is-invalid @enderror" 
                                   id="item" name="item" placeholder="Contoh: Semen, Bata, dll" value="{{ old('item') }}" required>
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('satuan') is-invalid @enderror" 
                                   id="satuan" name="satuan" placeholder="sak, unit, pcs" value="{{ old('satuan') }}" list="satuan-list">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-check form-switch mt-4">
                            <input class="form-check-input" type="checkbox" id="tax" name="tax" value="1" {{ old('tax') ? 'checked' : '' }}>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('project') is-invalid @enderror" 
                                   id="project" name="project" placeholder="Nama project" value="{{ old('project') }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('company') is-invalid @enderror" 
                                   id="company" name="company" placeholder="Nama perusahaan" value="{{ old('company') }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="ket" class="form-label">Kategori / Keterangan</label>
                            <input type="text" class="form-control @error('ket') is-invalid @enderror" 
                                   id="ket" name="ket" placeholder="Contoh: MATERIAL, ADM, dll" value="{{ old('ket') }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nota') is-invalid @enderror" 
                                   id="nota" name="nota" placeholder="Nomor nota/invoice" value="{{ old('nota') }}" required>
        ...
        <div class="card mt-3">
            <div class="card-header bg-warning text-dark">
                <h5 class="mb-0"><i class="fas fa-exchange-alt"></i> Klasifikasi & Status</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="account_id" class="form-label">Klasifikasi Akun <span class="text-danger">*</span></label>
                ...
                <div class="row">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="type_in">
                                        <i class="fas fa-arrow-down text-success"></i> IN (Uang Masuk)
                                    </label>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="type_out">
                                        <i class="fas fa-arrow-up text-danger"></i> OUT (Uang Keluar)
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="payment_status" id="lunas" value="lunas" {{ old('payment_status') == 'lunas' ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="lunas">
                                        <i class="fas fa-check-circle text-success"></i> LUNAS
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="payment_status" id="tidak_lunas" value="tidak_lunas" {{ old('payment_status') == 'tidak_lunas' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="tidak_lunas">
                                        <i class="fas fa-clock text-warning"></i> TIDAK LUNAS
                                    </label>
                                </div>
                            </div>
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0 mt-2">
                        <li><strong>IN + TIDAK LUNAS</strong> = PIUTANG (uang yang akan masuk tapi belum diterima)</li>
                        <li><strong>OUT + TIDAK LUNAS</strong> = HUTANG (uang yang harus dibayar tapi belum dibayar)</li>
                    </ul>
                </div>
            </div>
        </div>
